    ...
    <div>
      <a href="/" class="inline-block">
        <img src="{{ asset('images/logo.png') }}" alt="Green Generation Logo"
          class="h-50 w-50 md:w-24" />
      </a>

      <p class="text-md leading-relaxed mt-2">
        © GREEN GENERATION 2025 <br>
        Green Generation is an Independent Organization working on #Environment in Indonesia. Let’s create a generation with environmental culture. <br>“It’s Easy to be Green” 🍃
      </p>
    </div>
    ...
    <div class="flex md:flex-col gap-5 md:gap-5 items-start">
      ...
      <div>
        ...
        <ul class="space-y-2 text-md">
          <li><a href="/" class="hover:text-white transition-transform hover:scale-[1.02]">About us</a></li>
          <li><a href="/event" class="hover:text-white transition-transform hover:scale-[1.02]">Event</a></li>
          <li><a href="/blog" class="hover:text-white transition-transform hover:scale-[1.02]">Blog</a></li>
        </ul>
      </div>
      ...
      <div>
        ...
        <div class="flex items-center gap-2 text-xl">
          ...
          <a href="https://www.youtube.com/@GreenGenerationSurabaya" class="hover:text-white text-gray-400 transition">
            <i class="fa-brands fa-youtube"></i>
            <svg class="w-4 h-4 md:w-6 md:h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 180">

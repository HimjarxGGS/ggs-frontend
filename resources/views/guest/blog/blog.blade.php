...
<div class="min-h-screen flex flex-col">
    ...
    <section class="max-w-sm sm:max-w-lg md:max-w-5xl mx-auto py-12 px-4 sm:px-6 flex-1 items-center">
        ...
        <section class="max-w-5xl mx-auto text-center md:text-left">
            <div class="bg-palette-4 text-white rounded-2xl shadow-md flex flex-col md:flex-row items-center justify-between gap-6 px-7 md:px-20 py-4">
                <!-- Left: Text -->
                <div class="flex-1 pt-5 md:pt-0">
                    <h3 class="text-2xl md:text-2xl font-semibold">Got something to share?</h3>
                    <p class="text-xs md:text-sm text-palette-1 pt-2 md:pt-0.5">
                ...
                <div class="flex justify-center md:justify-end w-full md:w-auto">
                    <button
                        ...
                        class="bg-palette-3 text-white font-semibold px-8 py-3 rounded-full 
                       hover:bg-gray-500 transition duration-300 shadow-md hover:shadow-lg">
                        Submit Your Idea
                    </button>
                </div>
            </div>
        ...
        <section class="py-16 px-5">
            <div id="submitBlogForm" class="bg-palette-3 shadow-md rounded-3xl p-10">
                ...
                <form action="{{route('blog.submit')}}" method="POST" class="space-y-4 max-w-xl">
                    @csrf
                    ...
                    <div>
                        ...
                        <input type="email" id="email" name="email" placeholder="Use your valid email" required
                            value="{{ old('email') }}"
                            class="w-full px-7 py-2 rounded-2xl
                      focus:outline-none focus:ring focus:ring-palette-4 text-sm transition duration-300 bg-palette-1 text-palette-2">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="subject" name="subject" placeholder="Enter the blog title" required
                            value="{{ old('subject') }}"
                            class="w-full px-7 py-2
                      focus:outline-none focus:ring focus:ring-palette-4 text-sm rounded-2xl transition duration-300 bg-palette-1 text-palette-2">
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="content" name="content" placeholder="Enter blog content here ..." required
                            class="w-full px-7 py-5 rounded-2xl
                         focus:outline-none focus:ring focus:ring-palette-4 h-36 text-sm transition duration-300 bg-palette-1 text-palette-2">{{ old('content') }}</textarea>
                    </div>

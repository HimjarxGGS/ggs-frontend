...
@section('content')
    ...
    <section class="w-full px-7 md:px-24 py-16">
        <div class="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-10">
            ...
            <div class="w-full lg:w-1/2 flex flex-wrap justify-center gap-8">
                ...
                <!-- box 2 -->
                <div class="flex flex-col items-center text-center">
                    <img src="{{ asset('icons/Partner Organizations.png') }}" alt="icon"
                        class="w-10 h-10 md:w-16 md:h-16 mb-2" />
    ...
    <section class="w-full py-10 overflow-x-auto px-5 md:px-10 scrollbar-hide">
        <div class="flex gap-3 w-max">
            ...
            <div
                class="flex flex-col md:flex-row bg-white rounded-3xl shadow-lg overflow-hidden w-[350px] md:w-[700px] ease-in-out transition duration-500 hover:shadow-lg hover:shadow-gray-600">
    ...
    <section class="pt-24 px-6">
        ...
        <!-- logo partner -->
        <div
            class="grid grid-cols-3 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-x-7 gap-y-8 px-4 max-w-6xl mx-auto mt-14">
            <img src="{{ asset('images/TUS.png') }}" alt="Telkom University Surabaya" class="h-24" />
            <img src="{{ asset('images/cnn.png') }}" alt="CNN Indonesia" class="h-20" />
            <img src="{{ asset('images/komdigi.png') }}" alt="Kementerian Komunikasi dan Digital" class="h-24" />
            <img src="{{ asset('images/gojek.png') }}" alt="Gojek" class="h-24" />
            <img src="{{ asset('images/kahf.png') }}" alt="Kahf" class="h-24" />
            <img src="{{ asset('images/americancorener.png') }}" alt="American Corner Unair" class="h-24" />
            <img src="{{ asset('images/komunitasnarasijatim.png') }}" alt="Komunitas Narasi Jatim" class="h-24" />
            <img src="{{ asset('images/pepelingasihindonesia.png') }}" alt="Pepelingasih Indonesia" class="h-24" />
            <img src="{{ asset('images/UWK.png') }}" alt="Universitas Katolik Widya Mandala Surabaya" class="h-24" />
            <img src="{{ asset('images/noovoleum.png') }}" alt="Noovoleum" class="h-24" />

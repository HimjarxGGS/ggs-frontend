...
<header class="flex justify-center">
    ...
    <nav class="fixed mx-auto w-[95%] max-w-7xl rounded-full px-14 py-3 flex items-center justify-between lg:px-20 z-[100] transition-all duration-300 md:mt-8 mt-5">
        <!-- logo -->
        ...
        <div class="hidden lg:flex flex-1 justify-center gap-x-10 items-center">
            <a href="/" class="nav-link font-semibold transition-transform duration-300 transform hover:scale-[1.3]">Home</a>
            <a href="/event" class="nav-link font-semibold transition-transform duration-300 transform hover:scale-[1.3]">Event</a>
            <a href="/blog" class="nav-link  font-semibold transition-transform duration-300 transform hover:scale-[1.3]">Blog</a>
        </div>

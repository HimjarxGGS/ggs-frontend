...
<header class="flex justify-center">
   <nav class="fixed left-1/2 -translate-x-1/2 w-[95%] max-w-7xl rounded-xl px-4 py-3 flex items-center justify-between lg:px-8 z-[100] transition-all duration-300 mt-8">
        <!-- logo -->
    ...
    <div id="mobileMenu" class="hidden lg:hidden top-[110px] w-[90%] left-1/2 -translate-x-1/2 rounded-md bg-[#F2F2F7] backdrop-blur-3xl shadow-md py-7 text-center z-[99] fixed">
        <a href="/" class="nav-link block py-4 text-black font-bold hover:text-[#5e3929] transition duration-200">Home</a>

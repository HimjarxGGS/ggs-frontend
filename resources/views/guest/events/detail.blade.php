    ...
    <div class="max-w-6xl mx-auto px-4 mt-20 font-geist">
        ...
        <div class="grid md:grid-cols-2 gap-6 items-start">
            ...
            <div class="bg-transparent">
                <img src="{{ $event->poster ? asset('storage/' . $event->poster) : asset('images/posterggs.png') }}"
                    alt="Poster Event" class="w-full h-auto max-h-[900px] object-contain rounded-lg bg-transparent">
        ...
        @if ($event->status == 'finished')
            <section id="dokumentasi" class="mt-12 md:mt-20">
                ...
                <div
                    class="flex flex-col md:flex-row justify-center items-center gap-6 md:gap-10 overflow-hidden md:overflow-visible">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                @forelse($moreEvents as $i => $event)
                    <a href="{{ route('events.show', ['id' => $event->id]) }}"
                        class="block group w-full {{ $i >= 1 ? 'hidden sm:block' : '' }}">
                        <div

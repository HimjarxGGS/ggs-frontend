...
@section('content')
    <div class="container mx-auto px-4 py-10 mb-24 mt-24"> {{-- mt-24 kasih jarak dari navbar --}}
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
           ...
           <form action="{{ route('member.datadiri.save') }}" method="POST" enctype="multipart/form-data" class="w-full space-y-10">
                @csrf
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
                        ...
                        <div class="md:col-span-2 space-y-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label for="nama" class="block mb-2 text-sm font-semibold text-gray-700">Nama Lengkap <span class="w-1 h-1 mb-1 md:ml-0 ml-1 bg-red-500 rounded-full inline-block"></span></label>
                                ...
                                <div>
                                    <label for="email" class="block mb-2 text-sm font-semibold text-gray-700">Email <span class="w-1 h-1 mb-1 ml-1 md:ml-0 ml-1 bg-red-500 rounded-full inline-block"></span></label>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label for="asal_instansi" class="block mb-2 text-sm font-semibold text-gray-700">Asal Instansi<span class="w-1 h-1 mb-1 ml-1 bg-red-500 rounded-full inline-block"></span></label>
                                ...
                                <div>
                                    <label for="date_of_birth" class="block mb-2 text-sm font-semibold text-gray-700">Tanggal Lahir<span class="w-1 h-1 mb-1 ml-1 bg-red-500 rounded-full inline-block"></span></label>
                                ...
                                <div>
                                    <label for="telepon" class="block mb-2 text-sm font-semibold text-gray-700">No. Telepon<span class="w-1 h-1 mb-1 ml-1 bg-red-500 rounded-full inline-block"></span></label>
                                ...
                                <div>
                                    <label for="riwayat_penyakit" class="block mb-2 text-sm font-semibold text-gray-700">Riwayat Penyakit</label>
                        ...
                        <div class="flex flex-col gap-4 items-start w-full">
                            <label for="fotoInput" class="block text-sm font-semibold text-gray-700">Upload Foto<span class="w-1 h-1 mb-1 ml-1 bg-red-500 rounded-full inline-block"></span></label>
